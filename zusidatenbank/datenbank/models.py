...
class Fuehrerstand(InventoryItem):
  ZUGSICHERUNG_CHOICES = (
    ...
    ('LZB80_I80', 'LZB80/I80'),
    ('LZB80_CE_I80', 'LZB80/I80 CIR-ELKE'),
    ('LZB80_I80_ZUB262', 'LZB80/I80 + ZUB262'),
    ('LZB80_PZB90_20', 'LZB80/I80 PZB90 V2.0'),
    ('LZB80_PZB90_20_ZUB262', 'LZB80/I80 PZB90 V2.0 + ZUB262'),
    ('LZB80_CE_PZB90_20', 'LZB80/I80 CIR-ELKE PZB90 V2.0'),
    ('LZB80_CESBahn_PZB90_20', 'LZB80/I80 CIR-ELKE S-Bahn PZB90 V2.0'),
    ('LZB80E', 'LZB80E'),
    ('LZB80_CE_PZB90_20_ZUB262', 'LZB80 CIR-ELKE PZB90 V2.0 + ZUB262'),
    ('PZB90ER24_V20', 'PZB90 I60/ER24 V2.0'),
    ('PZB60', 'PZB60'),
    ('PZ80', 'PZ80'),
    ('ETCS', 'ETCS'),
  ...
  TUER_CHOICES = [('TB5','TB5'),('TB0','TB0'),('SAT','SAT'),('SST','SST'),('TAV','TAV'),('UICWTB','UIC WTB'),('SBahn423','S-Bahn 423'), ('SBahn474','S-Bahn 474')]
...
class FahrplanZug(InventoryItem):
  ...
  nummer = ArrayField(models.CharField(max_length=40))
